import { CHANGE_FALSE, CHANGE_QUESTION, CHANGE_TRUE, SET_SUCCESS_MESSAGE, MOVE_CLOCKWISE, MOVE_COUNTERCLOCKWISE, SET_INFO_MESSAGE, SET_QUIZ_INTO_STATE, SET_SELECTED_ANSWER, RESET_FORM } from "./action-types";
...
export function setSuccessMessage(successMessage) {
  return ({type: SET_SUCCESS_MESSAGE, payload: successMessage})
}
